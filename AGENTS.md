...
├── markets/   # Market adapters (us-stock, polymarket). Unified interface.
├── api/       # Hono server. DB operations live here, not in core.
...
- Use descriptive error codes: `INSUFFICIENT_BALANCE`, `INVALID_ORDER`, `MARKET_NOT_FOUND`, etc.
