import { BarChart3, Clock, Coins, DollarSign, Droplets, Loader2, Search, TrendingUp } from "lucide-react";

import { cn } from "../../lib/utils";
import { formatFundingRate } from "../../lib/funding";
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {searchResults.map((asset) => {
          ...
          const fundingLabel = asset.fundingPreview ? formatFundingRate(asset.fundingPreview.rate) : null;
          ...
          const stats = [
            ...
            fundingLabel && { icon: Coins, label: "Funding", value: fundingLabel, color: "text-sky-400" },
